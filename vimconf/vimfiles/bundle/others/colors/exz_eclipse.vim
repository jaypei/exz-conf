...
" Syntax group
highlight Comment    gui=none guifg=gray guibg=bg      ctermfg=2
...
highlight Special    gui=italic guifg=gray guibg=bg      ctermfg=DarkMagenta
highlight Statement  gui=none guifg=blue guibg=bg      ctermfg=White
...
highlight String     gui=italic guifg=#0DA914 guibg=bg      ctermfg=Yellow
