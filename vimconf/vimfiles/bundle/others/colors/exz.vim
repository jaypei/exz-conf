...
hi VertSplit        			gui=NONE		  guifg=#3195CA	        guibg=#C0C0FF
hi WarningMsg       			gui=NONE          guifg=#D900D9         guibg=#993333
hi WildMenu         			gui=NONE          guifg=#FFFFFF         guibg=#1C89F3
hi LineNr           			gui=NONE          guifg=#344EBC	   		guibg=#C0C0FF
...
" Status
""""""""""""""""""""""""
hi StatusLine       			gui=bold      	  guifg=#4E4ED3	    	guibg=#C0C0FF
hi StatusLineNC     			gui=NONE		  guifg=#FFFFFF       	guibg=#3195CA
...
" Visual
""""""""""""""""""""""""
hi Visual          				gui=NONE          guifg=NONE        	guibg=#C3DCFF
...
" Search
""""""""""""""""""""""""
hi IncSearch        			gui=NONE          guifg=NONE         guibg=#FFFF00
hi Search           			gui=NONE          guifg=NONE         guibg=#FFFF00
...
hi String           			gui=NONE          guifg=#619E16       	guibg=NONE
hi Character        			gui=NONE          guifg=#009999         guibg=NONE
hi Number           			gui=NONE          guifg=#0000CD      	guibg=NONE
hi Boolean          			gui=NONE          guifg=#009999       	guibg=NONE
hi Float            			gui=NONE          guifg=#0000CD       	guibg=NONE
hi Comment          			gui=NONE          guifg=#009DFF         guibg=NONE

hi Identifier       			gui=NONE          guifg=#595959       	guibg=NONE
hi Function         			gui=BOLD          guifg=#3A00A2         guibg=NONE

hi Statement        			gui=NONE          guifg=#0000FF     	guibg=NONE
hi Keyword          			gui=BOLD          guifg=#6D79E1       	guibg=NONE

hi Conditional      			gui=BOLD          guifg=#3A00FF     	guibg=NONE
hi Repeat           			gui=BOLD          guifg=#3A00FF     	guibg=NONE
hi Label            			gui=NONE          guifg=#595959   		guibg=NONE
hi Operator         			gui=NONE          guifg=#0000FF         guibg=NONE
...
hi Define           			gui=BOLD          guifg=#3A00FF    		guibg=NONE
...
hi Underlined       			gui=underline     guifg=#D900D9         guibg=NONE
...
hi htmlString					gui=NONE		  guifg=#619E16			guibg=NONE
hi htmlComment					gui=NONE		  guifg=#009DFF			guibg=NONE
hi htmlCommentPart				gui=NONE		  guifg=#009DFF			guibg=NONE
...
hi xmlString					gui=NONE		  guifg=#619E16			guibg=NONE
hi xmlComment					gui=NONE		  guifg=#009DFF			guibg=NONE
hi xmlCommentStart				gui=NONE		  guifg=#009DFF			guibg=NONE
hi xmlCommentPart				gui=NONE		  guifg=#009DFF			guibg=NONE
...
hi javaScriptComment			gui=NONE		  guifg=#009DFF			guibg=NONE
hi javaScriptLineComment		gui=NONE		  guifg=#009DFF			guibg=NONE
hi javaScriptStringD			gui=NONE		  guifg=#619E16			guibg=NONE
hi javaScriptNumber				gui=NONE		  guifg=#0000CD			guibg=NONE
hi javaScriptConditional		gui=BOLD		  guifg=#3A00FF			guibg=NONE
hi javaScriptRepeat				gui=BOLD		  guifg=#3A00FF			guibg=NONE
hi javaScriptBranch				gui=NONE		  guifg=#595959			guibg=NONE
hi javaScriptStatement			gui=NONE		  guifg=#0000FF			guibg=NONE
hi javaScriptFunction			gui=BOLD		  guifg=#3A00A2			guibg=NONE
...
hi javaScriptRegexpString		gui=NONE		  guifg=#619E16			guibg=NONE
...
" CSS
""""""""""""""""""""""""
hi cssComment					gui=NONE		  guifg=#009DFF			guibg=NONE
...
hi cssString					gui=NONE		  guifg=#619E16			guibg=NONE
...
hi cssValueNumber				gui=NONE		  guifg=#0000CD			guibg=NONE
hi cssFunctionName				gui=BOLD		  guifg=#3A00A2			guibg=NONE
...
" PHP
""""""""""""""""""""""""
hi phpComment					gui=NONE		  guifg=#009DFF			guibg=NONE
hi phpBoolean					gui=NONE		  guifg=#008C00			guibg=NONE
hi phpStructure					gui=NONE		  guifg=#1C89F3			guibg=NONE
hi phpStringSingle				gui=NONE		  guifg=#619E16			guibg=NONE
hi phpStringDouble				gui=NONE		  guifg=#619E16			guibg=NONE
hi phpNumber					gui=NONE		  guifg=#0000CD			guibg=NONE
hi phpFloat						gui=NONE		  guifg=#0000CD			guibg=NONE
hi phpMethods					gui=NONE		  guifg=#1C89F3			guibg=NONE
hi phpFunctions					gui=BOLD		  guifg=#3A00A2			guibg=NONE
hi phpRepeat					gui=BOLD		  guifg=#3A00FF			guibg=NONE
hi phpConditional				gui=BOLD		  guifg=#3A00FF			guibg=NONE
hi phpLabel						gui=NONE		  guifg=#595959			guibg=NONE
hi phpStatement					gui=NONE		  guifg=#0000FF			guibg=NONE
hi phpKeyword					gui=BOLD		  guifg=#6D79E1			guibg=NONE
hi phpType						gui=NONE		  guifg=#000000			guibg=NONE
hi phpInclude					gui=NONE		  guifg=#6CD900			guibg=NONE
hi phpDefine					gui=BOLD		  guifg=#3A00FF			guibg=NONE
hi phpParent					gui=BOLD		  guifg=#3A00FF			guibg=NONE
hi phpOperator					gui=NONE		  guifg=#0000FF			guibg=NONE
hi phpVarSelector				gui=NONE		  guifg=#3195CA			guibg=NONE
hi phpIdentifier				gui=NONE		  guifg=#3195CA			guibg=NONE
...
hi cString						gui=NONE		  guifg=#619E16			guibg=NONE
hi cComment						gui=NONE		  guifg=#009DFF			guibg=NONE
...
" Python
""""""""""""""""""""""""
hi pythonBuiltin				gui=NONE		  guifg=#1C89F3			guibg=red
hi pythonStatement				gui=NONE		  guifg=#0000FF			guibg=NONE
hi pythonConditional			gui=BOLD		  guifg=#3A00FF			guibg=NONE
hi pythonRepeat					gui=BOLD		  guifg=#3A00FF			guibg=NONE
hi pythonOperator				gui=NONE		  guifg=#0000FF			guibg=NONE
hi pythonInclude				gui=NONE		  guifg=#6CD900			guibg=red
hi pythonFunction				gui=BOLD		  guifg=#3A00A2			guibg=NONE
hi pythonComment				gui=NONE		  guifg=#009DFF			guibg=NONE
hi pythonTodo					gui=NONE		  guifg=#FFFFFF			guibg=#E60027
hi pythonString					gui=NONE		  guifg=#619E16			guibg=NONE
hi pythonRawString				gui=NONE		  guifg=#619E16			guibg=red
hi pythonNumber					gui=NONE		  guifg=#0000CD			guibg=NONE
hi pythonFloat		            gui=NONE          guifg=#0000CD         guibg=NONE
hi pythonDoctest				gui=NONE		  guifg=#1C89F3			guibg=red
hi pythonDoctestValue			gui=NONE		  guifg=#1C89F3			guibg=red
hi pythonDot                    gui=NONE          guifg=#0000FF         guibg=NONE
hi pythonEscape			        gui=NONE          guifg=#8DE127         guibg=NONE
hi pythonBytesEscape		    gui=NONE          guifg=#8DE127         guibg=NONE
hi pythonCoding		            gui=NONE          guifg=#0066FF         guibg=#D8FDC9
hi pythonPreCondit	            gui=BOLD          guifg=NONE            guibg=NONE
hi pythonHexNumber	            gui=NONE          guifg=#0000CD         guibg=NONE
hi pythonOctNumber	            gui=NONE          guifg=#0000CD         guibg=NONE
hi pythonBinNumber	            gui=NONE          guifg=#0000CD         guibg=NONE

hi pythonException	gui=NONE        guifg=NONE      guibg=yellow
hi pythonDecorator	gui=NONE        guifg=NONE      guibg=yellow
hi pythonDottedName	gui=NONE        guifg=NONE      guibg=yellow
hi pythonRun		gui=NONE        guifg=NONE      guibg=yellow
hi pythonBytes		    gui=NONE        guifg=NONE      guibg=yellow
hi pythonBytesContent	    gui=NONE        guifg=NONE      guibg=yellow
hi pythonStrFormatting	gui=NONE        guifg=NONE      guibg=yellow
hi pythonStrFormat    	gui=NONE        guifg=NONE      guibg=yellow
hi pythonStrTemplate	    gui=NONE        guifg=NONE      guibg=yellow
hi pythonDocTest2		gui=NONE        guifg=NONE      guibg=yellow
hi pythonBuiltinObj	gui=NONE        guifg=NONE      guibg=yellow
hi pythonBuiltinFunc	gui=NONE        guifg=NONE      guibg=yellow
hi pythonExClass	gui=NONE        guifg=NONE      guibg=yellow

hi pythonError		gui=NONE        guifg=NONE      guibg=yellow
hi pythonNumberError  gui=NONE      guifg=NONE      guibg=yellow
hi pythonOctError	    gui=NONE        guifg=NONE      guibg=yellow
hi pythonHexError		gui=NONE        guifg=NONE      guibg=yellow
hi pythonBinError		gui=NONE        guifg=NONE      guibg=yellow
hi pythonBytesEscapeError	gui=NONE        guifg=NONE      guibg=yellow
hi pythonBytesError	    gui=NONE        guifg=NONE      guibg=yellow
hi pythonEscapeError		gui=NONE        guifg=NONE      guibg=yellow
hi pythonIndentError	gui=NONE        guifg=NONE      guibg=yellow
hi pythonSpaceError	gui=NONE        guifg=NONE      guibg=yellow
...
hi rubyDefine					gui=BOLD		  guifg=#3A00FF			guibg=NONE
hi rubyFunction					gui=BOLD		  guifg=#3A00A2			guibg=NONE
hi rubyConditional				gui=BOLD		  guifg=#3A00FF			guibg=NONE
hi rubyConditionalModifier		gui=BOLD		  guifg=#3A00FF 		guibg=NONE
hi rubyRepeat					gui=BOLD		  guifg=#3A00FF			guibg=NONE
hi rubyRepeatModifier			gui=BOLD		  guifg=#3A00FF			guibg=NONE
...
hi rubyFloat					gui=NONE		  guifg=#0000CD			guibg=NONE
...
hi rubyComment					gui=NONE		  guifg=#009DFF			guibg=NONE
hi rubyTodo						gui=NONE		  guifg=#FFFFFF			guibg=#993333

hi rubyStringEscape				gui=NONE		  guifg=#619E16			guibg=NONE
hi rubyInterpolationDelimiter	gui=NONE		  guifg=#595959			guibg=NONE
hi rubySymbolDelimiter			gui=NONE		  guifg=#595959			guibg=NONE
hi rubyStringDelimiter			gui=NONE		  guifg=#619E16			guibg=NONE
hi rubyString					gui=NONE		  guifg=#619E16			guibg=NONE
...
hi Keyword          			cterm=BOLD          ctermfg=darkgrey       	ctermbg=NONE
